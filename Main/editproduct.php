...
$sql="SELECT * from medicine where  med_id='".$_GET['id']."'";
                                ...
                                <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Packaging</label>
                                                     <select  id="med_class" name="med_pack"  required class="form-control">

                                                     <option value=""><?php echo $result['med_pack']?></option>
                        <?php 
                        ...
                        ?>
                                        ...
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Dosage</label>
                                                   <input type="text" class="form-control" id="med_dosage" placeholder="Dosage" name="med_dosage" value="<?php echo $result['med_dosage']?>" autocomplete="off" />
                                        </div>
                                        
                                    </div>
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Classification</label>
                                                     <select  id="med_class" name="med_class"  required class="form-control">

                                                     <option value=""><?php echo $result['med_class']?></option>
                        <?php 
