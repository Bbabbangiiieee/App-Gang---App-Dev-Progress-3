                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                    ...
                                    <div class="form-group col-md-12" style="margin-left:50px;">
                                        ...
                                        <div class="col-md-6 form-check">
                                            <input type="checkbox" class="pl-3" id="exampleCheck1" style="margin-left:20px;">
                                            <label class="form-check-label" for="exampleCheck1">Remember Me</label>
                                        </div>

                                        <div class="forgot-phone col-md-6 text-right">
                                            <a href="#" class="text-right f-w-500 text-gray"> Forgot Password?</a>
                                        </div>
